...
const contentSections = [
  ...
  },
  {
    ...
    data: {
      items: [
        { title: '汽车润滑油项目', description: '为汽车行业提供高性能润滑油解决方案', imageUrl: '' },
        { title: '工业润滑油项目', description: '工业设备润滑维护一站式服务', imageUrl: '' },
        { title: '特种油品研发', description: '针对特殊场景定制研发油品', imageUrl: '' },
        { title: '品牌定制服务', description: '成熟的品牌定制与产品包装方案', imageUrl: '' },
        { title: '导热油项目', description: '高温导热油应用解决方案', imageUrl: '' },
        { title: '合成油脂项目', description: '高性能合成油脂研发与生产', imageUrl: '' }
      ]
    }
  },
  {
